...
(function ($, Drupal, drupalSettings, displace) {
  ...
  $.extend(TableHeader.prototype, {
    ...
    createSticky: function createSticky() {
      ...
      this.$stickyTable = $('<table class="uk-table uk-table-small sticky-header"/>').css({
        visibility: 'hidden',
        position: 'fixed',
        top: '0px'
    ...
    stickyPosition: function stickyPosition(offsetTop, offsetLeft) {
      ...
      if (typeof offsetTop === 'number') {
        ...
        if (navbar.css('position') === 'fixed') {
          offsetTop = offsetTop + header.outerHeight(false);
        }
        else if (stickyNavbar) {
          offsetTop = 0;
        }
...
})(jQuery, Drupal, drupalSettings, window.parent.Drupal.displace);